...
void loop() { 
  ...
  int function_100_to_200=(-2.55)*(distance-100)+255; // 거리 100부터 200까지 analogWrite 함수 입력값 계산
  int function_200_to_300=2.55*(distance-200); // 거리 200부터 300까지 analogWrite 함수 입력값 계산
  ...
  if ((distance == 0.0) || (distance > _DIST_MAX)) {
      ...
      analogWrite(PIN_LED, function_100_to_200);
  } else if (distance >= 200.0 && distance <= _DIST_MAX) {  
      analogWrite(PIN_LED, function_200_to_300);
  } else {    
